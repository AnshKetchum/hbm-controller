...
object Elaborate extends App {
  ...
  ChiselStage.emitSystemVerilogFile(new SingleChannelSystem(SingleChannelMemoryConfigurationParams(MemoryConfigurationParameters(), DRAMBankParameters())), args, firtoolOptions)
}
