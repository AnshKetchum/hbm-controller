...
class BankPerformanceStatistics(localConfiguration: LocalConfigurationParameters) extends Module {
  ...
  val perfMemRequests = Module(new BankPhysicalMemoryRequestPerformanceStatistics(localConfiguration.rankIndex, localConfiguration.bankGroupIndex, localConfiguration.bankIndex))
  val perfMemResponses = Module(new BankPhysicalMemoryResponsePerformanceStatistics(localConfiguration.rankIndex, localConfiguration.bankGroupIndex, localConfiguration.bankIndex))
